...
export class PreloadedPageManager {
  ...
  public static async create (puppeteerBrowser: Browser, preloadConfig: PreloadConfig, poolSize: number = generalSettings.preloadedPagesPerCourt): Promise<PreloadedPageManager> {
